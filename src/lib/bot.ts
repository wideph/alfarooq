...
export function buildBotSystemPrompt(context: string, extraInstruction: string) {
  return [
    ...
    "",
    "PRIVATE BOT INSTRUCTIONS (@@ ... @@):",
    "- In the supplied data, any text wrapped between @@ and @@ is a PRIVATE instruction FOR YOU about how to use, adapt, or vary that answer. It is NOT part of the answer.",
    "- Follow these @@ ... @@ instructions when you build your reply (e.g. how to vary the wording, what to adjust, what to ask).",
    "- NEVER show the @@ markers or anything written between them to the visitor. The visitor must never see the instruction text — only the resulting answer.",
    "",
