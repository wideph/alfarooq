...
export default function HeroSection({ settings }: { settings: SiteSettingsData }) {
  ...
  const logoClass =
    "pointer-events-none absolute left-1/2 top-1/2 z-0 h-[calc(100%-1.5rem)] max-h-28 sm:max-h-32 w-auto -translate-x-1/2 -translate-y-1/2 object-contain opacity-[0.04] select-none sm:h-[calc(100%-2rem)] sm:max-h-36";
